...
const Footer = () => {
  return (
    <footer className="bg-base-200 text-base-content">
      <div className="footer max-w-7xl mx-auto p-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        {/* Logo & Description */}
        <div className="col-span-1">
          <img src={logo} alt="Footer Logo" className="w-32 mb-4" />
          <p className="text-sm leading-relaxed">
            Your trusted platform to post tasks, hire freelancers, and get jobs
            done efficiently.
          </p>
        ...
        <nav>
          ...
          <Link to="/add-task" className="link link-hover">
            Add Task
          </Link>
          <Link to="/browse-tasks" className="link link-hover">
            Browse Tasks
          </Link>
          <Link to="/my-posted-tasks" className="link link-hover">
            My Tasks
          </Link>
      ...
      <div className="text-center py-4 border-t border-base-300 text-sm">
        © {new Date().getFullYear()} Freelance Task Marketplace. All rights
        reserved.
      </div>
    </footer>
  );
